...
const CONTACT_ADDRESS = "0x006EC5a93393511696801B50D2a86990c928C518";

export async function doLogin () {
  if (!window.ethereum) {
    throw new Error("Sem metamask instalada!");
  }
...
function getContract () {
  ...
  return new web3.eth.Contract(ABI, CONTACT_ADDRESS, { from: wallet });
}
